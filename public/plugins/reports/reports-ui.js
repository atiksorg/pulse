...
(function() {
  ...
  function _injectModalHtml() {
    ...
    var html = [
      ...
      '          <input id="r_botToken" type="password" placeholder="••••••••">',
      '          <div style="font-size:10px;color:var(--muted-2);margin-top:2px;">',
      '            Текущий: <span id="r_botTokenHint" style="font-family:var(--mono);">—</span>',
      '          </div>',
      '        </div>',
      '      </div>',
      '      <div class="field-row">',
      ...
      '          <input id="r_tgToken" type="password" placeholder="••••••••">',
      '          <div style="font-size:10px;color:var(--muted-2);margin-top:2px;">',
      '            Текущий: <span id="r_tgTokenHint" style="font-family:var(--mono);">—</span>',
      '          </div>',
      '        </div>',
      '      </div>',
      '      <div class="field-row">',
