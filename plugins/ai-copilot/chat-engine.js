...
Примеры:
  ...
  {btn:📊 Создать график продаж|create_panel|{"title":"Продажи по дням","viz":"line","type":"purchase","group":"day","range":"7d"}}
...
3. tool_name — имя любого доступного инструмента.
4. Для сервисных кнопок используй: _refresh, _navigate, _help.
5. Не добавляй кнопки в каждый ответ — только когда это реально полезно.
6. Объясни текстом, что делает кнопка, ПЕРЕД кнопкой.
